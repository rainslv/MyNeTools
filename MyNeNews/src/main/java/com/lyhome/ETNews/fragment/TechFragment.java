...
import com.lyhome.ETNews.view.HeadlinesView;
...
public class TechFragment extends Fragment {
    ...
    private void initView(View view) {
        mSrl = (SwipeRefreshLayout) view.findViewById(com.lyhome.ETNews.R.id.srl_content);
        mSrl.setColorSchemeResources(com.lyhome.ETNews.R.color.colorPrimary,
                com.lyhome.ETNews.R.color.secondColor, com.lyhome.ETNews.R.color.purple,
                com.lyhome.ETNews.R.color.blue);
        ...
        btnReload = (Button) view.findViewById(com.lyhome.ETNews.R.id.refresh_btn);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(com.lyhome.ETNews.R.layout.fragment_tech, container, false);
    }
